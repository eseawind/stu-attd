...
<html>
  ...
  <body bgcolor="ghostwhite">
   <div class="PageTitleArea">
	    <div class="PageTitle">记录管理</div>	
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a class="SmallCommonTextButton" href="<%=path%>/admin/recordAction!excute"><font color="red">新增资产记录 </font> </a>
   </div>
   <fieldset class="AdminSearchform">       
       ...
       <div class="grdGroupListLi">
	     <div>
	       <br>
	       <s:form name ="form1" action="recordAction!queryAllRecord.action"  method="POST" theme="simple" id="from1">
				<table>
		  		<tr>
		    		 <td>
					...
					<s:if test="name == null">
						...
						<s:iterator value="#request.recordList">
							<tr class="grdrow">
								...
								<td style="width: 25%;">
									<div align="center">
										<s:property value="tbRecord.type"/>
									</div>
								</td>
								-->
								<td style="width: 25%;">
