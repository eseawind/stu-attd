	...
	<body bgcolor="ghostwhite">
		...
		<fieldset class="AdminSearchform">
			...
			<div class="grdGroupListLi">
				<s:form name="form1" action="recordAction!updateRecord" method="POST"
					theme="simple" name="form1" enctype="multipart/form-data">
					<table width="60%" border="0" cellpadding="0" cellspacing="0"
						id="addItemsTable">
						<s:hidden name="tbRecord.tbRecordId" value="%{tbRecord.tbRecordId}"></s:hidden>
						<tr>
							<td>
								<font color="red">*</font>资产记录编号:
							</td>
							<td>
								<s:textfield id="title" name="tbRecord.tbRecordId"
