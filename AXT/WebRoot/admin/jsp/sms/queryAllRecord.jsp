  ...
  <head>
    ...
    <script type="text/javascript" src="<%=path%>/admin/js/Calendar.js"></script>
   	...
   	<script type="text/javascript">
   		 function setSms(id) {
    			window.location.href = "${pageContext.request.contextPath}/admin/queryAction!setSendFlag.action?tbRecord.id="+id;
    	 }
   	</script>
  </head>
   ...
   <div class="PageTitleArea">
       ...
       <div class="grdGroupListLi">
	     <div>
	       ...
	       <br><s:form name ="form1" action="queryAction!queryAllRecordSms.action"  method="POST" theme="simple" id="from1">
								...
								<td style="width: 25%;">
									<div align="center">
										<s:if test="sendflag == 0">
											<a class="SmallCommonTextButton" href='javascript:setSms(<s:property value="id"/>)'>发送短信</a>    
										</s:if>
										<s:if test="sendflag == 1">
											<a class="SmallCommonTextButton" href='javascript:setSms(<s:property value="id"/>)'><font color= "red">不发送</font></a>
										</s:if>
									</div>
								</td>
							</tr>
